...
Window_Selectable.prototype.setHelpWindow2 = function (
  ...
  this._helpWindow = helpWindow1
  this._helpWindow2 = helpWindow2
  this.callUpdateHelp()
}
...
Window_Selectable.prototype.showHelpWindow = function () {
  ...
  if (this._helpWindow2) {
    this._helpWindow2.show()
  }
}
...
Window_Selectable.prototype.setHelpWindowItem = function (item) {
  ...
  if (this._helpWindow2) {
    this._helpWindow2.setItem(item)
  }
}
...
Window_Help2.prototype.drawSpecial = function (filename) {
  ...
  bitmap.addLoadListener(
    function () {
      ...
      var y = (this._height >> 1) - (bitmap.height >> 1) - 13
      if (y < -13) y = -13 // フレーム余白修正
      //console.log(this.width, this.height, bitmap.width, bitmap.height, x, y)
