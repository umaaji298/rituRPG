...
(function () {
    ...
    BattleManager.startAction = function () {
        ...
        //console.log("Change skill : BattleManager.startAction", currentAction)
        if (currentAction && !currentAction._forcing && !BattleManager._execBeforeCommon) { // umaaji add 多重閃き防止 // 2度呼び防止
            ...
            if (cItem && !this.flashSkill(cItem)) {
                ...
                action._forcing = true // umaaji add 閃き技はコスト不足でも強制的に発動する
