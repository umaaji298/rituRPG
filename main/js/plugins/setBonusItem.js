...
(function () {
  ...
  function chkBonus(total_num) {
    var bonusList = [1, 7, 15, 25, 35, 40, 47, 49, 52, 60, 70, 80, 90, 95, 99, 100, 103, 107, 108]
  ...
  function createClsUpMsg(total_num, rank) {
    var clsList = ["無職", "お客さん", "下忍", "荒武者", "大剣士", "ハンター", "ギャル", "ギャル！", "勇者", "リツプロ", "先に進む者", "聖闘士", "ママ", "としあき", "ママン", "開眼", "真実を知るもの", "覇者", "ゴール", "りつ姉"]
...
\x1bC[17]すぺしゃる \x1bC[1]\x1bi[${i_id.iconIndex}]${i_id.name} \x1bC[0]を覚えた。`
      ...
      case 12:
        {
          i_id = $dataWeapons[12]
          $gameParty.gainItem($dataWeapons[12], 1) // アイテム取得
...
\x1bC[17]すぺしゃる \x1bC[1]\x1bi[${i_id.iconIndex}]真実 \x1bC[0]を知った・・・。`
      ...
      case 17:
        {
          i_id = $dataWeapons[22]
          $gameParty.gainItem($dataWeapons[22], 1) // アイテム取得          
          msg = `日曜が終わった！
\x1bC[17]すぺしゃる \x1bC[1]\x1bi[${i_id.iconIndex}]コメント \x1bC[0]を得た。`
          break
      ...
      case 18:
        {
          i_id = $dataWeapons[23]
          $gameParty.gainItem($dataWeapons[23], 1) // アイテム取得          
          msg = `りつ姉の全てを理解した！
\x1bC[17]すぺしゃる \x1bC[1]\x1bi[${i_id.iconIndex}]${i_id.name} \x1bC[0]を得た。`
          break
